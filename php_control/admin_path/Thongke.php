...
<div class="body_path">
    ...
    <p>&emsp;&emsp;Hiển thị thông tin:&ensp;</p>
        ...
        <img src="../assets/icon/filter.png?v=<?php echo filemtime("../assets/icon/filter.png"); ?>" alt="Tùy chọn" title="Tùy chọn" class="chart_option">
    </div>
...
<script>
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'], // Nhãn cho các cột
                datasets: [{
                    label: 'Doanh thu hàng tháng',
                    data: [1200, 1900, 3000, 5000, 2200, 3200], // Dữ liệu cho biểu đồ
                    backgroundColor: [
                        'rgba(75, 192, 192, 0.2)',
