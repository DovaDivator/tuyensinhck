...
//			}
			...
			switch(type) {
			case "fetch": {
				boolean fetchdata = KyThiManagerDAO.fetchExamstatus(conn, request.getParameter("id"));
				jsonResponse.put("data", fetchdata);
				break;
			}
			case "list": {
				JSONArray examList = ExamDataDAO.fetchExamList(conn, request.getParameter("id"));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			case "list": {
				JSONArray examList = ExamDataDAO.fetchExamList(conn, user.getId());
				jsonResponse.put("data", examList);
				break;
			}
